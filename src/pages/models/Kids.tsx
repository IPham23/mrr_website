  ...
  return (
    <div className="w-full py-24">
      ...
      <div className="flex flex-col gap-12 px-24 mt-12 max-lg:px-10 max-md:px-6">
        ...
        {/* Row 3 (only 2 centered images) */}
        <div className="flex justify-center gap-7">
          {["20", "15"].map((n) => (
            <div
              key={n}
              className="relative w-[340px] h-[360px] overflow-hidden cursor-pointer transform skew-x-[-20deg] max-lg:w-[300px] max-lg:h-[320px] max-md:w-[240px] max-md:h-[280px] max-sm:w-[80%] max-sm:h-[220px]"
            >
              <img
                src={`/src/assets/Artboard ${n}.png`}
                alt={`Thai Model ${n}`}
