        ...
        <div className="w-full py-25">
            ...
            <section className="flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col gap-5 py-5 px-20">
                    {/*Row 1 */}
                    <div className="lg:max-xl:pl-[100px] lg:max-xl:min-h-[250px] xl:max-2xl:min-h-[300px] xl:max-2xl:pl-[120px] pl-[140px] grid grid-cols-4 gap-5 min-h-[360px] justify-items-start">
                        <div className="lg:max-xl:h-[250px] xl:max-2xl:h-[300px] relative overflow-hidden h-[360px] z-1 skew-x-[-20deg]">
                    ...
                    {/*Row 2 */}
                    <div className="lg:max-xl:pr-[80px] lg:max-xl:min-h-[250px] xl:max-2xl:min-h-[300px]  pr-[140px] grid grid-cols-4 gap-5 min-h-[360px] justify-items-start">
                        <div className="lg:max-xl:h-[250px] xl:max-2xl:h-[300px] relative overflow-hidden h-[360px] z-1 skew-x-[-20deg]">
                            <div className="performersImageWrapper cursor-pointer"
                        ...
                        {/*Contact Us tile*/}
                        <div className="lg:max-xl:h-[250px] xl:max-2xl:h-[300px] lg:max-xl:max-w-[280px] lg:max-xl:ml-[20px] relative bg-[var(--bg)] text-[var(--text)] flex flex-col justify-center items-center p-5 gap-[30px] ml-10 mr-[-140px]">
            ...
            <section className="flex flex-col items-center justify-center pb-25">
                ...
                <div className="lg:max-xl:px-[150px] xl:max-2xl:px-[200px] flex gap-[90px] px-[288px] w-full justify-between">
                    <div
            ...
            <section className="lg:max-xl:px-[100px] flex flex-col items-center justify-center pb-25 px-40 bg-[#cfcfcf]">
                ...
                <div className="lg:max-2xl:gap-[60px] grid grid-cols-3 gap-30">
