    ...
    return(
        ...
        <div className="w-full py-25">
                        ...
                        <div className="relative overflow-hidden h-[360px] z-1 skew-x-[-20deg]">
                            <div className="performersImageWrapper cursor-pointer"
                                 onClick={() => openLightbox("./src/assets/Artboard-5.png")}>
                                    <img className="block w-full h-auto object-cover skew-x-[20deg] scale-[1.6] translate-y-[70px] transition-all duration-400 ease-in-out hover:translate-x-[-10px]"
            ...
            <section className="flex flex-col items-center justify-center pb-25">
                ...
                <p className="text-xl pb-[60px]">Showcase your talents and be known...</p>
            ...
            {/*EVENTS SECTION */}
            <section className="flex flex-col items-center justify-center pb-25 px-40 bg-[#cfcfcf]">
