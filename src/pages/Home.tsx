  ...
  return (
    <>
      <div className="sm:max-md:px-[20px] sm:max-md:max-w-[100%] sm:max-md:mx-[0px] max-w-[1600px] mx-auto overflow-x-hidden">
        ...
        {/*Texts */}
        <section className="sm:max-md:mt-[-10%] sm:max-md:pt-0 sm:max-md:w-[100%] sm:max-md:mx-0 lg:max-xl:mx-[0px] lg:max-xl:ml-[20px] xl:max-xl:ml-[144px] lg:max-xl:text-lg w-1/2 mx-[210px] pt-20">
          <img className="sm:max-md:w-[50%] sm:max-md:ml-auto" src="/src/assets/MANILA.png" alt="Manila" />
          <p className="sm:max-md:px-0 lg:max-xl:px-0 xl:max-xl:px-25 lg:max-xl:ml-20 px-30 py-10 text-center">
          ...
          <img
            className="sm:max-md:mr-auto sm:max-md:w-[70%] sm:max-md:pr-0 lg:max-xl:pr-0 justify-self-end pr-16"
        ...
        {/*Desktop Images */}
        <section className="sm:max-md:hidden lg:max-xl:translate-y-[-55%] lg:max-xl:grid lg:max-xl:grid-cols-4 lg:max-xl:px-0 w-100% px-30 flex items-end justify-center translate-y-[-45%]">
          <img
            src="/src/assets/HomeImg1.png"
            alt="Home Image 1"
        ...
        <section className="sm:max-md:translate-y-[0%] lg:max-xl:translate-y-[-60%] sm:max-md:pt-10 sm:max-md:px-0 lg:max-xl:px-5 px-20 translate-y-[-80%]">
