...
const Home = () => {
  return (
    ...
    <div className="max-w-[1600px] mx-auto overflow-x-hidden">
      <section className="w-1/2 mx-[210px] pt-20">
        <img src="/src/assets/MANILA.png" alt="Manila" />
        <p className="px-30 py-10 text-center">
        ...
        <img className="justify-self-end pr-16" src="/src/assets/RUNWAY.png" alt="Runway" />

      </section>
      <section className="w-100% px-30 flex items-end translate-y-[-45%]">
        <img src="/src/assets/HomeImg1.png" 
            alt="Home Image 1" 
            className="transition-transform duration-400 ease-in-out hover:translate-x-[5px]"
        />
        <img src="/src/assets/HomeImg2.png" 
            alt="Home Image 2" 
            className="ml-[-70px] transition-transform duration-400 ease-in-out hover:translate-x-[5px]"
        />
        ...
        <img src="/src/assets/HomeImg4.png" 
            alt="Home Image 4" 
            className="ml-[-145px] transition-transform duration-400 ease-in-out hover:translate-x-[5px]"
        />

      </section>
      <section className="px-20 translate-y-[-80%]">
