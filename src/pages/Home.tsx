...
const Home = () => {
  return (
    <>
      <div className=" max-sm:px-[20px] max-sm:max-w-[320px] max-w-[1600px] mx-auto overflow-x-hidden">
        <section className="max-sm:w-[100%] max-sm:mx-0 lg:max-xl:mx-[0px] lg:max-xl:ml-[20px] xl:max-xl:ml-[144px] lg:max-xl:text-lg w-1/2 mx-[210px] pt-20">
          <img src="/src/assets/MANILA.png" alt="Manila" />
          <p className="max-sm:px-0 lg:max-xl:px-0 xl:max-xl:px-25 lg:max-xl:ml-20 px-30 py-10 text-center">
          ...
          <img
            className="lg:max-xl:pr-0 justify-self-end pr-16"
            src="/src/assets/RUNWAY.png"
            alt="Runway"
          />
        </section>
        <section className="lg:max-xl:translate-y-[-55%] lg:max-xl:grid lg:max-xl:grid-cols-4 lg:max-xl:px-0 w-100% px-30 flex items-end justify-center translate-y-[-45%]">
          <img
        ...
        <section className="lg:max-xl:translate-y-[-60%] lg:max-xl:px-5 px-20 translate-y-[-80%]">
